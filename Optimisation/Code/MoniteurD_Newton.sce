...
// ----------------------------
   ...
   // Exemple : la fonction "optim" de Scilab
   //
   //[fopt,xopt,gopt] = Gradient_F(OraclePG,xini);   //OK
   //[fopt,xopt,gopt] = Gradient_PR(OraclePG,xini);    // OK
   //[fopt,xopt,gopt] = Gradient_BFGS(OraclePG,xini);  // OK
   //[fopt,xopt,gopt] = Newton(OraclePH,xini);  // OK


   //[fopt,xopt,gopt] = Gradient_F(OracleDH,lambdaini);   //OK
   [fopt,xopt,gopt] = Newton(OracleDH,lambdaini);   //OK
   // -----> A completer...
